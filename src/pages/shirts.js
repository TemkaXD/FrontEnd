        ...
        <div className="flex w-full items-center">
          <div className="flex w-full md:w-1/3">
            ...
            <ul className="hidden gap-6 text-sm md:flex md:items-center">
              ...
              <li>
                <a className="text-neutral-500 underline-offset-4 hover:text-black hover:underline" href="/search/shirts">
                  Shirts
                </a>
              </li>
              <li>
      ...
      <main className="mx-auto flex max-w-screen-2xl flex-col gap-8 px-4 pb-4 md:flex-row">
        <div className="order-first w-full flex-none md:max-w-[125px]">
          <nav>
            ...
            <ul className="hidden md:block space-y-2">
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">All</a></li>
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">Bags</a></li>
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">Drinkware</a></li>
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">Electronics</a></li>
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">Footwear</a></li>
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">Headwear</a></li>
              <li><a href="#" className="text-sm underline underline-offset-4 font-medium">Shirts</a></li>
              <li><a href="#" className="text-sm text-neutral-500 underline-offset-4 hover:text-black hover:underline dark:text-neutral-400 dark:hover:text-neutral-300">Stickers</a></li>
            </ul>
          </nav>
        </div>
        ...
        <div className="order-none flex-none md:order-last md:w-[125px]">
          <nav>
            ...
            <ul className="hidden md:block space-y-2">
              <li><a href="#" className="text-sm underline underline-offset-4 hover:underline">Relevance</a></li>
              <li><a href="#" className="text-sm hover:underline hover:underline-offset-4">Trending</a></li>
              <li><a href="#" className="text-sm hover:underline hover:underline-offset-4">Latest arrivals</a></li>
              <li><a href="#" className="text-sm hover:underline hover:underline-offset-4">Price: Low to high</a></li>
              <li><a href="#" className="text-sm hover:underline hover:underline-offset-4">Price: High to low</a></li>
            </ul>
          </nav>
        </div>
      </main>
