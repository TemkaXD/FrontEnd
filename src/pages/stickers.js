        ...
        <div className="order-first w-full flex-none md:max-w-[125px]">
          <nav>
            ...
            <ul className="hidden md:block space-y-2">
              ...
              <li><a href="#" className="text-sm underline underline-offset-4 font-medium">Stickers</a></li>
            </ul>
          </nav>
        </div>
        ...
        <div className="order-last min-h-screen w-full md:order-none">
          <ul className="grid grid-flow-row gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
            {filteredStickers.map(sticker => (
              <li key={sticker.id} className="aspect-square transition-opacity animate-fadeIn">
                    ...
                    <div className="absolute bottom-0 left-0 flex w-full px-4 pb-4">
                      <div className="flex items-center rounded-full border bg-white/70 p-1 text-xs font-semibold text-black backdrop-blur-md dark:border-neutral-800 dark:bg-black/70 dark:text-white w-full">
                        ...
                        <p className="flex-none rounded-full bg-blue-600 p-2 text-white">
                          ${sticker.price}.00 <span className="ml-1">USD</span>
                        </p>
                      </div>
                    </div>
                  </div>
